...
export const initAIAdvisor = (Store, Utils) => {
    ...
    bubble.innerHTML = `
        ...
        <p id="ai-advice-text" class="text-[11px] font-bold text-slate-700 dark:text-slate-300 leading-relaxed italic relative z-10" style="white-space: pre-wrap !important; font-family: inherit;">
